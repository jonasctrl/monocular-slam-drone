...
while True:
    ...
    client.moveToPositionAsync(home_x, home_y, home_z - 5, 2).join()
    client.moveToPositionAsync(home_x, home_y, home_z, 2).join()
    ...
    client.moveToPositionAsync(home_x, home_y - 5, home_z, 2).join()
    client.moveToPositionAsync(home_x, home_y, home_z, 2).join()
    ...
    client.rotateByYawRateAsync(45, 8).join()  # 45 degrees per second for 8 seconds to complete 360 degrees
